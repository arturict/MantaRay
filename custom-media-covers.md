# 🧩 Add-on: Custom media covers for MantaFin
...
#### **MantaFin Fork:** [arturict](https://github.com/arturict)
...
```
@import url("https://cdn.jsdelivr.net/gh/arturict/MantaRay@main/Theme/assets/add-ons/custom-media-covers-latest-min.css");
```
